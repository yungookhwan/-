...
MONTHLY_MARKET_ISSUES = {
    "2026-01": {
        ...
        "철광석(Iron Ore)": "중국 춘절 연휴 대비 제철소 동절기 재고 확충 수요 견인",
        "니켈(Ni)": "연초 스테인리스 비수기 및 인도네시아 NPI 공급 우위 지속",
        "아연(Zn)": "LME 재고 안정 속 글로벌 인프라 도금재 수요 관망 흐름"
    },
    "2026-02": {
        "유가(WTI)": "글로벌 경기 회복 지표 및 정유사 가동률 상승으로 견조한 흐름",
        "나프타(Naphtha)": "석유화학 스프레드 축소 압박 속 원료가 완만한 상승세",
        "철광석(Iron Ore)": "중국 양회 정책 기대감 및 부동산 인프라 부양 모멘텀 반영",
        "니켈(Ni)": "배터리 양극재 수요 둔화 우려 완화 및 저가 매수세 유입",
        "아연(Zn)": "중국 춘절 이후 제련소 가동 재개 및 도금재 출하 증가"
    },
    "2026-03": {
        "유가(WTI)": "중동 지정학적 리스크 확산 및 주요 해협 통행 불안에 급등",
        "나프타(Naphtha)": "원유가 급등 직결 및 역내 납사 분해설비 원가 부담 가중",
        "철광석(Iron Ore)": "중국 제철소 감산 지침 및 철강 유통 재고 증가로 조정",
        "니켈(Ni)": "글로벌 공급망 병목 및 유럽 STS 공장 주문 회복세 반영",
        "아연(Zn)": "글로벌 제련소 에너지 비용 부담 및 정련 아연 재고 감소"
    },
    "2026-04": {
        "유가(WTI)": "산유국 공급 차질 우려 지속 및 80달러 중후반대 안착 흐름",
        "나프타(Naphtha)": "고유가 장기화 반영으로 기초유분 원가 최고점 기록",
        "철광석(Iron Ore)": "중국 조강 생산량 억제 정책 속 제철용 원료 수요 관망",
        "니켈(Ni)": "러시아산 비철 제재 강화 여파 및 LME 실물 재고 타이트",
        "아연(Zn)": "글로벌 제련 수수료(TC) 급락 시작 및 제련소 감산 소식 영향"
    },
    "2026-05": {
    ...
    "2026-06": {
        ...
        "철광석(Iron Ore)": "중국 장마철 진입에 따른 건설 조업 차질로 수요 둔화",
        "니켈(Ni)": "전기차 판매량 성장세 둔화 및 배터리용 니켈 재고 누적",
        "아연(Zn)": "주요 제련소 정기보수 집중 구간 진입으로 박스권 등락"
    },
    "2026-07": {
        "유가(WTI)": "미국 드라이빙 시즌 진입 및 글로벌 원유 재고 감소세 반등",
        "나프타(Naphtha)": "아시아 석화사 가동률 하향 조정으로 수급 균형 모색",
        "철광석(Iron Ore)": "중국 부동산 경기 침체 장기화 및 100달러선 하회 압력",
    ...
    "2026-08": {
        ...
        "니켈(Ni)": "저점 인식 매수세 유입 및 니켈 광석 수입 규제 이슈 반영",
...
"""
    ...
    market_drivers = {
        ...
        "아연(Zn)": "제련 수수료(TC) 변동 및 인프라 도금재 출하 동향",
...
def fetch_monthly_history(item_name, conf):
    """2026년 1월부터의 일일 데이터를 가져와 월평균으로 집계"""
    ...
    if "multiplier" in conf:
        ...
        # 9월 단가를 타겟 단가(16,500 / 3,950)에 정확히 앵커링 후 과거 지수 역산
...
def main():
    ...
    try:
        ...
        try:
            ...
            worksheet.clear()  # 기존 시트 초기화 후 정합성 데이터 재적재
